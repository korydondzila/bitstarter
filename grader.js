...
References:
	...
	- https://tjholowaychuk.com/post/9103188408/commander-js-nodejs-command-line-interfaces-made-easy
...
var loadHtmlUrl = function( weburl ) {
    var resultstr = restler.get( weburl ).on( 'complete', function( result ) {
...
if ( require.main == module ) {
	...
	.option( '-u, --url <url_file>', 'A URL argument', url )
	.parse( process.argv );
    if ( program.url != null ) {
	loadHtmlUrl( program.url );
    } else {
